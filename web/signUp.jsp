...
<div class = "container-fluid" style="background-color: #fcba03; min-height: 660px">
    <div class = "row" >
        <div class = "col-6 mx-auto" style="margin-top: 150px">
            ...
            <input type="text" class = "form-control" name = "full_name" placeholder="Enter your Full Name" form = "form">
            <form action="/signup" method="post" id = "form">
                <button class = "btn-success mt-3 w-100 h-25" style="border-radius: 30px">Sign Up</button>
            </form>
        </div>
    </div>
</div>
